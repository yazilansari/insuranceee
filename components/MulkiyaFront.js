...
export default class MulkiyaFront extends React.Component {
  state = {
    loading: false,
    image: null,
    error: null,
          ...
          {(this.state.loading) ? <ActivityIndicator style={{ marginTop: 20, textAlign: 'center' }} size="large" color="tomato" /> :
            <>{ (this.state.visionResp != '') ? (<Container>
              ...
              return (
                ...
                <TouchableOpacity onPress={() => { this.props.navigation.navigate('Registration Card Back', { test: 'Test' }) }} style={styles.fab}>
