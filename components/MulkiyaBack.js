...
export default class MulkiyaBack extends React.Component {
  state = {
    loading: false,
    image: null,
    error: null,
          ...
          >
            ...
            <>{ (this.state.visionResp != '') ? (<Container>
              ...
              return (
                ...
                <TouchableOpacity onPress={() => { this.props.navigation.navigate('Emirates Id Front', { test: 'Test' }) }} style={styles.fab}>
