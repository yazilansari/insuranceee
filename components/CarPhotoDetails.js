...
export default class CarPhotoDetails extends React.Component {
  ...
  render() {
    ...
    if(this.state.image1 != null && this.state.image2 != null && this.state.image3 != null && this.state.image4 != null && (this.state.price != 0 || this.state.cylinderShow == 1)) {
        car_photo_render = <TouchableOpacity onPress={() => { this.props.navigation.navigate('Insurance List', { test: 'Test', type: this.state.typeSelected, compCategory: this.state.compCategorySelected, partyCategory: this.state.partyCategorySelected, cylinder: this.state.cylinderSelected, age: this.state.ageSelected, price: this.state.price, vehicle_images: this.state.images}) }} style={styles.fab}>
                            <Text style={styles.fabIcon}><Icon size={ 18 } name='check-circle'/> { I18n.t('CONFIRM') }</Text>
                          </TouchableOpacity>;
    } else {
      if(this.state.image1 == null) {
          car_photo_render = <TouchableOpacity onPress={() => { this.props.navigation.push('Vehicle Photos', { test: 'Test' }) }} style={{...styles.fab, width: 150}}>
                                <Text style={styles.fabIcon}><Icon size={ 18 } name='camera'/> { I18n.t('FRONT SIDE') }</Text>
                              </TouchableOpacity>;
      } else if (this.state.image2 == null) {
          car_photo_render = <TouchableOpacity onPress={() => { this.props.navigation.push('Vehicle Photos', { test: 'Test' }) }} style={{...styles.fab, width: 140}}>
                                <Text style={styles.fabIcon}><Icon size={ 18 } name='camera'/> { I18n.t('REAR SIDE') }</Text>
                              </TouchableOpacity>;
      } else if(this.state.image3 == null) {
          car_photo_render = <TouchableOpacity onPress={() => { this.props.navigation.push('Vehicle Photos', { test: 'Test' }) }} style={{...styles.fab, width: 140}}>
                                <Text style={styles.fabIcon}><Icon size={ 18 } name='camera'/> { I18n.t('LEFT SIDE') }</Text>
                              </TouchableOpacity>;
      } else if(this.state.image4 == null) {
          car_photo_render = <TouchableOpacity onPress={() => { this.props.navigation.push('Vehicle Photos', { test: 'Test' }) }} style={{...styles.fab, width: 140}}>
                                <Text style={styles.fabIcon}><Icon size={ 18 } name='camera'/> { I18n.t('RIGHT SIDE') }</Text>
                              </TouchableOpacity>;
    }
  }
      ...
      <>
        ...
        <Container>
          <ImageBackground source={require('../assets/take_care.jpeg')} style = {{ height: 150, marginBottom: 20 }}>
            {/*<Text style={{ marginTop: 100, textAlign: 'center' }}><Text style={{ color: '#fff', fontSize: 18, fontWeight: 'bold' }}>{ I18n.t('INSURE WITH CONVENIENCE') }</Text></Text>*/}
            <Text style={{ marginTop: 100, textAlign: 'center' }}><Text style={{ color: '#fff', fontSize: I18n.t('CAR FONT SIZE') }}>{ I18n.t('INSURE') }</Text><Text style={{ fontSize: I18n.t('CAR FONT SIZE'), color: '#E86143', fontWeight: 'bold' }}> { I18n.t('WITH CONVENIENCE') }</Text></Text>
          </ImageBackground>
          {/*<StepIndicator
          ...
          {(this.state.image1 != null && this.state.image2 != null && this.state.image3 != null && this.state.image4 != null) ?
            ...
            {(this.state.image1 != null && this.state.image2 != null && this.state.image3 != null && this.state.image4 != null && this.state.typeSelected != '' &&
            (<Item picker>
            ...
            {(this.state.image1 != null && this.state.image2 != null && this.state.image3 != null && this.state.image4 != null && this.state.typeSelected == 'comprehensive' && <Item>
