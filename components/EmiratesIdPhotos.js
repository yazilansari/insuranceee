...
import CarPhotoDetails from "./CarPhotoDetails";
...
export default class PassportPhotos extends React.Component {
  state = {
    loading: false,
    image: null,
    error: null,
  ...
  takePicture = async camera => {
    ...
    try {
      ...
      this.setState(
        ...
        () => {
          console.log('Passport Photos===', data);
          this.props.navigation.navigate('Emirates Id Photo Details', {
