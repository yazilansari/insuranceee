...
export default class EmirateIdBack extends React.Component {
  state = {
    loading: false,
    image: null,
    error: null,
          ...
          >
            ...
            <>{ (this.state.visionResp != '') ? (<Container>
              ...
              return (
                ...
                <TouchableOpacity onPress={() => { this.props.navigation.navigate('Driving License Front', { test: 'Test' }) }} style={styles.fab}>
