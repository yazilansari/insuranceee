...
export default class PassingCertificate extends React.Component {
  state = {
    loading: false,
    image: null,
    error: null,
          ...
          >
            ...
            <>{ (this.state.visionResp != '') ? (<Container>
              ...
              return (
                ...
                <TouchableOpacity onPress={() => { this.props.navigation.navigate('Vehicle Photos', { test: 'Test' }) }} style={styles.fab}>
